...
def evaluate(y_true: Iterable, y_pred: Iterable, zero_division: int = 0) -> Dict[str, float]:
    ...
    return {
        ...
        "precision": float(precision_score(y_true, y_pred, average=avg, zero_division=zero_division)),
        "recall": float(recall_score(y_true, y_pred, average=avg, zero_division=zero_division)),
        "f1": float(f1_score(y_true, y_pred, average=avg, zero_division=zero_division)),
    }
...
def classification_summary(y_true: Iterable, y_pred: Iterable, *, labels: Iterable | None = None) -> str:
